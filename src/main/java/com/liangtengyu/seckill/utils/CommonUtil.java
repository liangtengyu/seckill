...
import com.liangtengyu.seckill.common.config.redis.CacheSelector;
import com.liangtengyu.seckill.common.config.redis.CacheService;
...
public class CommonUtil {
    ...
    public static User getCurrentUser() {
        ...
        UserMapper userService = SpringContextUtil.getBean(UserMapper.class);
        CacheService cacheService = SpringContextUtil.getBean(CacheService.class);

        return selectCacheByTemplate(() -> cacheService.getUser(username), () -> userService.selectByname(username));
    }
